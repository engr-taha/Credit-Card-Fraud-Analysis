...
fraud_trans_m <- fraud_transactions %>% filter(category == "grocery_pos")
...
ggplot(data = gen_count, 
  ...
  labs(x = "Gender", y = "Fraud Count", title = "Fraud Count Vs Gender [Merchant Category = grocery_pos]", 
...
ggplot(data = male_count, 
  ...
  geom_col(width = 0.5, fill = "cornflowerblue") +
  labs(x = "Gender", y = "Fraud Count", title = "Top 5 male fraudsters [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") +
  theme_classic() +
...
ggplot(data = fem_count, 
       aes(x = reorder(card_owner, -fraud_count), y = fraud_count)) +
  geom_col(width = 0.5, fill = "cornflowerblue") +
  labs(x = "Gender", y = "Fraud Count", title = "Top 5 female fraudsters [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") +
  theme_classic() +
  scale_y_continuous(breaks=seq(0, 14,by=2)) +
  theme(axis.text.x=element_text(angle=30, hjust=1))
...
ggplot(data = fraud_trans_m, aes(x = amount)) +
  geom_histogram(binwidth = 25, fill = "cornflowerblue") +
  labs(x = "Amount", y = "Fraud Count", title = "Frauds w.r.t. Fraud Amount [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") + 
...
ggplot(data = fraud_trans_m, aes(x = age)) +
  ...
  labs(x = "age", y = "Fraud Count", title = "Fraud Count Vs Age  [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") + 
...
ggplot(data = month_count, aes(x = reorder(trans_month, level), y = count)) +
  ...
  labs(x = "Month", y = "Fraud Count", title = "Frauds in Different Months of a Year  [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") + 
  theme_classic()
...
ggplot(data = hourly, 
  ...
  labs(x = "Hour", y = "Fraud Count", title = "Hourly trend of frauds [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") +
  theme_classic() +
...
ggplot(data = merchant, 
  ...
  geom_col(width = 0.7, fill= "cornflowerblue") +
  labs(x = "Merchant", y = "Fraud Count", title = "Frauds on Different Merchants [Merchant Category = grocery_pos]",
...
ggplot(data = state, 
  ...
  labs(x = "State", y = "Fraud Count", 
       title = "Frauds in Different States [Merchant Category = grocery_pos]", 
       caption = "2019 Credit Card Fraud Data") +
  theme_classic()
